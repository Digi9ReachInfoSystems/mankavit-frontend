...
export default function NotesManagement() {
  ...
  const handleOpenModal = (type, data) => {
    ...
    const handleViewClick = () => {
        navigate("/admin/mock-test/view");
    }

  return (
    <>
      <ButtonContainer>
        <CreateButton onClick={() => navigate("/admin/mock-test/create")}>
          Add Mock Test
        </CreateButton>
      </ButtonContainer>
      ...
      <Container>
              ...
              {currentItems.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    ...
                    <a
                      href="#view"
                      onClick={() => handleOpenModal("enrolled", item.students)}
                    >
                      View
                    </a>
                  </TableCell>
        ...
        {viewModalOpen && viewStudent && (
          <CustomModal
            title={viewStudent.type === "enrolled" ? "enrolled" : "Details"}
