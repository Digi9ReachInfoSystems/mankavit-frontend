...
import { deleteWhyOurCourseById, getAllWhyOurCourse } from "../../../../api/whyOurCourseApi";
...
const WhyOurCourse = () => {
  ...
  const handleDeleteConfirm = async () => {
    try {
      await deleteWhyOurCourseById(selectedId);
  ...
  return (
    <>
      <BtnAchieve>
        {
          !readOnlyPermissions && (
            <AddButton onClick={() => navigate("/admin/web-management/why-our-course/create")}>
              Add
            </AddButton>
          )
        }
                ...
                <tr key={item._id}>
                  ...
                  <Td>
                    <IoEyeOutline
                      ...
                      onClick={() =>
                        navigate(`/admin/web-management/why-our-course/view/${item._id}`)
                      }
                    />
                    {
                      !readOnlyPermissions && (
                        <>
                          <BiEditAlt
                            ...
                            style={{ cursor: "pointer", marginRight: 10 }}
                            onClick={() =>
                              navigate(`/admin/web-management/why-our-course/edit/${item._id}`)
                            }
                          />
                          <RiDeleteBin6Line
                            size={20}
