    ...
    <div style={{ position: 'relative', width: '100%', height: '600px' }}>
      <div
        ...
        <Button
          ...
          onClick={() => {
            window.open(`https://zoom.us/s/${meetingData.meetingNumber}?pwd=${meetingData.passWord}`, '_blank');
          }}>
          Login in and join in New Tab
        </Button>
      </div>
...
export default ZoomIframeMeeting;