...
// import { set } from "date-fns";
// import { getAuth } from "../../../../utils/authService";
// import { getBackendAssets } from "../../../../api/authApi"; // ⬅️ NEW
...
//           fileURL: item.fileUrl, // may be a key (not absolute)
//         }));
//         setData(dataPrepared);
//       } catch (error) {
//         console.error("Error fetching data:", error);
...
//   // ⬇️ NEW: robust opener for PDFs (handles keys and absolute URLs)
//   const handleOpenPdf = async (fileURL) => {
//     try {
//       if (!fileURL) return;

//       // If already absolute, just open it.
...
//       // Otherwise, assume it's a storage key -> ask backend for a signed URL.
//       const res = await getBackendAssets(fileURL); // { url: "https://signed..." }
...
//       // Fallback to resource proxy if backend didn't return a URL
//       const fallback = `${import.meta.env.VITE_APP_IMAGE_ACCESS}/api/project/resource?fileKey=${encodeURIComponent(fileURL)}`;
//       window.open(fallback, "_blank", "noopener,noreferrer");
//     } catch (err) {
//       console.error("Open PDF failed, using fallback:", err);
//       const fallback = `${import.meta.env.VITE_APP_IMAGE_ACCESS}/api/project/resource?fileKey=${encodeURIComponent(fileURL)}`;
//       window.open(fallback, "_blank", "noopener,noreferrer");
//     }
//   };
...
//                   <TableCell>
//                     <Link
//                       to={`/admin/notes-management/edit/${item.id}`}
//                       target="_blank"
//                       rel="noopener noreferrer"
//                     >
//                       {item.noteTitle}
...
//                   <TableCell>
//                     {item.subjects.length}{" "}
//                     <a href="#view-subjects" onClick={(e) => { e.preventDefault(); handleOpenModal("subjects", item.subjects); }}>
//                       View
//                     </a>
//                   </TableCell>

//                   <TableCell>
//                     {/* ⬇️ Use click handler to open absolute/signed URL in new tab */}
//                     <a
//                       href="#open-pdf"
//                       onClick={(e) => {
//                         e.preventDefault();
