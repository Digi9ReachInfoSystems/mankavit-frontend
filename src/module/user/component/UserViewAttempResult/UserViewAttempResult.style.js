...
export const ToggleSidebarBtn = styled.button`
  ...
  @media (max-width: 576px) { right: 6px; }
`;
...
export const LeftDiv = styled.div`
  display: flex;
  align-items: center;
  gap: 6px; /* tight gap between back and title */
`;
...
export const Section = styled.div`
  display: flex;
  @media (max-width: 990px) { flex-direction: column; }
`;
...
/* Option coloring for result view */
...
/* ===== Sticky action bar (parity with other screens) ===== */
...
export const LegendText = styled.div`
  font-size: 0.85rem;
  @media (max-width: 1360px) { font-size: 0.65rem; }
`;
...
export const GridButton = styled.button`
  ...
  &.correct { background: #34c759; color: #fff; }
  &.incorrect { background: #ff3b30; color: #fff; }
  &.not-answered { background: #fff; color: #333; }
